...
public class ActionActivity extends AppCompatActivity {
    ...
    private static final int TAG_HAND_SIDE = 13370;

    private AtomicBoolean decisionUnlocked = new AtomicBoolean(false);
    ...
    public void onClickDecision(View v) {
        ...
        final boolean negate = "lhs".equals(v.getTag(TAG_HAND_SIDE));
